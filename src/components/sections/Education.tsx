              ...
              <div className="flex flex-col gap-4">
                <div className="flex justify-between items-start gap-4">
                  <div className="flex gap-3 items-center">
                    {edu.logo}
                    <div>
                      <h3 className="text-base sm:text-xl font-semibold line-clamp-2">{edu.degree}</h3>
                      <p className="text-xs sm:text-base text-muted-foreground whitespace-prewrap">{edu.course}</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-2 text-muted-foreground">
                    <span className="text-sm sm:text-base font-medium">{edu.grade}</span>
                    <Award className="h-4 w-4 flex-shrink-0" />
                  </div>
                </div>
                <div className="flex flex-col gap-1 text-muted-foreground">
                  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 sm:gap-4">
                    <div className="flex flex-col sm:flex-row sm:flex-wrap sm:items-center gap-2 sm:gap-x-2">
                    ...
                    <div className="hidden sm:flex items-center justify-end gap-2 text-muted-foreground whitespace-nowrap">
                      <span className="text-sm sm:text-base">{edu.period}</span>
                      <Calendar className="h-4 w-4" />
                    </div>
                  </div>
